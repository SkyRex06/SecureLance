...
const Auth = () => {
  ...
  const handleSignIn = async (values: z.infer<typeof formSchema>) => {
    ...
    setIsLoading(true);
    try {
      const nonceResponse = await axios.get(`http://localhost:5001/api/v1/auth/nonce/${address}`);
      ...
      const verifyResponse = await axios.post('http://localhost:5001/api/v1/auth/verify', {
        address,
        signature,
